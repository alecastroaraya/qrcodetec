...
(() => {
var exports = {};
exports.id = "pages/api/readQR";
exports.ids = ["pages/api/readQR"];
exports.modules = {
...
/***/ "(api)/./pages/api/readQR.js":
/*!*****************************!*\
  !*** ./pages/api/readQR.js ***!
  \*****************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _lib_mongodb__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../lib/mongodb */ \"(api)/./lib/mongodb.ts\");\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async (req, res)=>{\n    try {\n        const provincia = req.body.provincia;\n        const canton = req.body.canton;\n        const qrUrl = req.body.qrUrl;\n        const client = await _lib_mongodb__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n        const db = client.db(\"qrcodes\");\n        await db.collection(\"qr_visits\").updateOne({\n            qrUrl,\n            provincia,\n            canton\n        }, {\n            $inc: {\n                visits: 1\n            }\n        }, {\n            upsert: true\n        } // crear el registro si no existe\n        );\n        res.json({\n            url: qrUrl\n        });\n    } catch (e) {\n        console.error(e);\n        throw new Error(e).message;\n    }\n});\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/readQR.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/readQR.js"));
